...
public class EchoClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) {
        ...
        System.out.println("[CLIENT]" + "I am client !! - channelActive");
        ByteBuf bufActiveMessage = Unpooled.wrappedBuffer("I am client !! - channelActive".getBytes());
        ctx.writeAndFlush(bufActiveMessage);
    }
